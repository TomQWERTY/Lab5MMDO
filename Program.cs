...
namespace Lab5MMDO
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Function f1 = (x) => x[0] * x[0] + Math.Exp(2 * x[0] * x[0] + x[1] * x[1]) + x[0] - x[1];
            double e = Math.Pow(10, -4);
            double[] ans = MethodLibrary.ReiskiMehod(n, f1, new double[2] { 2, 1 }, e * 10000000, Math.Pow(10, -4));
            Console.WriteLine(ans[0] + " " + ans[1]);
            ans = MethodLibrary.PokoordReiski(n, new double[2] { -2, 1 }, e * 10000, e * 1000, e, f1);
            Console.WriteLine(ans[0] + " " + ans[1]);
